...
export function registerUserTweetsCommand(program, ctx) {
    ...
    program
        ...
        .argument('<handle>', 'Username to fetch tweets from (e.g., @erlinhoxha or erlinhoxha)')
        ...
        formatExample('bird user-tweets @erlinhoxha', 'Get recent tweets from a user'),
        formatExample('bird user-tweets erlinhoxha -n 10', 'Get 10 tweets (@ is optional)'),
        formatExample('bird user-tweets @erlinhoxha -n 50', 'Fetch 50 tweets (paged)'),
        formatExample('bird user-tweets @erlinhoxha --max-pages 3 -n 200', 'Safety cap (max 3 pages)'),
        formatExample('bird user-tweets @erlinhoxha --json', 'Output as JSON'),
        formatExample('bird user-tweets @erlinhoxha --cursor "DAABCg..."', 'Resume from cursor'),
    ].join('\n')}`)
