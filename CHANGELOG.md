...
### Changed
- Cookie extraction now uses Bird's built-in browser readers (replaces the earlier external `@erlinhoxha/sweet-cookie` dependency and keeps the `sqlite3` CLI out of `bird`).
